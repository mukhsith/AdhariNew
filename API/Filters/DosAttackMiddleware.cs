...
namespace API.Filters
{
    public class DosAttackMiddleware
    {
        ...
        private const int BannedRequests = 15;
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            Common.SaveIPDetails("Requested IP:" + ip);
            ...
            if (context.Request.Path.Value.Contains("/Pdfs/"))
            {
                validateIpAddress = false;
            }
            ...
            {
                Common.SaveIPDetails("Request retunrned with status code 403 for IP:" + ip);
        ...
        private static void CheckIpAddress(string ip)
        {
            ...
            if (ipaddres != null)
            {
                ...
                {
                    Common.SaveIPDetails("Added in Banned List IP:" + ip);
                    Banned.Push(ip);
