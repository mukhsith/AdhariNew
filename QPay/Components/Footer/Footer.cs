...
namespace Web.Components
{
    ...
    public class Footer : ViewComponent
    {
        ...
        public Footer(IAPIHelper apiHelper,
            ...
            IOptions<AppSettingsModel> options)
        {
            ...
            _logger = logger.CreateLogger(typeof(Footer).Name);
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            try
            {
                var responseModel = await _apiHelper.GetAsync<APIResponseModel<CompanySettingModel>>("webapi/common/companysetting");
